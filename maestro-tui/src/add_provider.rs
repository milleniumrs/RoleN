//! "Add Provider" wizard dialog (Requirements FR-1.2, TUI-DESIGN.md §3.3).

use appcui::prelude::*;
use maestro_core::types::{Model, Provider, ProviderType};
...
impl AddProviderDialog {
    ...
    fn on_save(&mut self) {
        ...
        if !key.is_empty() {
            ...
            if let Err(e) = maestro_core::secrets::set_secret(&kref, &key) {
