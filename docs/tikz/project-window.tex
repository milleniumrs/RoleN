...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  % toolbar
  \foreach \b/\x in {{[> Run]}/0.75, {[|| Pause]}/2.05, {[+ Task]}/3.4, {[? Interview]}/4.9, {[Requirements]}/6.5, {[AGENTS.md]}/7.8, {[Skills]}/9.3} {
    \node[btn] at (\x,5.35) {\b};
  }
  ...
  \foreach \t/\x in {Chat/7.65, Files/8.75, Ledger/9.9, Requirements/10.95} {
    \node[tab] at (\x,4.75) {\t};
  }
  \draw[black!30, line width=0.4pt] (5.7,4.5) -- (15.3,4.5);
  \node[mono] at (5.85,4.15) {goal, Requirements summary, progress bars,};
